...
var parser = wrapGenerator.mark(function parser() {
  var arr, flags, more, long, length, upperLength, body;

  return wrapGenerator(function parser$($ctx0) {
    ...
    case 1:
      ...
      return $ctx0.delegateYield(read.u8(), "t0", 3);
    case 3:
      flags = $ctx0.t0;
      more = bit(flags, 0);
      long = bit(flags, 1);
      ...
      return $ctx0.delegateYield(read.u8(), "t1", 8);
    case 8:
      length = $ctx0.t1;
      $ctx0.next = 17;
      break;
    case 11:
      return $ctx0.delegateYield(read.u32(), "t2", 12);
    case 12:
      upperLength = $ctx0.t2;
    ...
    case 15:
      return $ctx0.delegateYield(read.u32(), "t3", 16);
    case 16:
      length = $ctx0.t3;
    case 17:
      $ctx0.next = 19;
